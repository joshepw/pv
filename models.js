...
const ValuesConfig = {
	...
	DeviceRadiatorTemperature: ['oC', 'thermometer', 'temperature', 'measurement'],
	DeviceTransformerTemperature: ['oC', 'thermometer', 'temperature', 'measurement'],
	...
	BatteryTemperature: ['oC', 'thermometer', 'temperature', 'measurement'],
